...
class Parser:
    ...
    def parser(self):
       ...
       self.DocumentsList = [{'Description': results[k]['Description'], 'Title': results[k]['Title'],'Url': results[k]['Url'], 'IsRelevant': None, 'Body': None, 'URLBody': None} for k in range(resultLength)]
